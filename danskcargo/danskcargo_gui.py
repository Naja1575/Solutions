...
def delete_transport(tree, record):  # delete tuple in database
    transport = dcd.Transport.convert_from_tuple(record)  # Convert tuple to Container
...
tree_aircraft.heading("max_cargo_weight", text="Max_Cargo_Weight", anchor=tk.CENTER)
...
label_aircraft_max_cargo_weight = tk.Label(edit_frame_aircraft, text="Max_Cargo_Weight")
...
tree_transport.column("container_id", anchor=tk.W, width=100)
tree_transport.column("aircraft_id", anchor=tk.W, width=100)
...
tree_transport.heading("container_id", text="Container_id", anchor=tk.CENTER)
tree_transport.heading("aircraft_id", text="Aircraft_id", anchor=tk.CENTER)
